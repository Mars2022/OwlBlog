    ...
    <div class="head-container">
        ...
        <span id="rightHeaderContainer">
            <div style="float: right;">
                <span class="tabs"><a href="/pages/index.jsp"><font color="#ffffff">主页</font> </a></span>
                <span class="tabs"><a href="/pages/blog_person.jsp"><font color="#ffffff">我的主页</font></a></span>
                <span class="tabs"><a href="/pages/write_blog.jsp"><font color="#ffffff">写博客</font></a></span>
                <span class="tabs"><a href="/pages/user_center/user_center_userInfo.jsp"><font
                        color="#ffffff">个人中心</font></a></span>


                <form id="search" class="searching-box input-group">
                    <input type="text" class="form-control " placeholder="请输入要查找的内容" aria-describedby="basic-addon"
                           id="search-text">
